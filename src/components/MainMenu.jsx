...
import soundEffect from "/src/assets/audio/Recharged.wav"
...
const MainMenuScreen = () => {
    ...
    const ScoutLink = <Link to='scout'><button onMouseEnter={() => setScoutHover(true)} onMouseLeave={() => setScoutHover(false)} className="mercBtn" id="scoutBtn"><img className='emblem' src="/src/assets/emblems/Scout_emblem_RED.png" alt="Scout Emblem" /></button></Link>
    const SoldierLink = <Link to='soldier'><button className="mercBtn" onMouseEnter={() => setSoldierHover(true)} onMouseLeave={() => setSoldierHover(false)} id="soldierBtn"><img className='emblem' src="/src/assets/emblems/Soldier_emblem_RED.png" alt="Soldier Emblem" /></button></Link>
    const PyroLink = <Link to='pyro'><button className="mercBtn" onMouseEnter={() => setPyroHover(true)} onMouseLeave={() => setPyroHover(false)} id="pyroBtn"><img className='emblem' src="/src/assets/emblems/Pyro_emblem_RED.png" alt="Pyro Emblem" /></button></Link>
    const DemomanLink = <Link to='demoman'><button className="mercBtn" onMouseEnter={() => setDemomanHover(true)} onMouseLeave={() => setDemomanHover(false)} id="demomanBtn"><img className='emblem' src="/src/assets/emblems/Demoman_emblem_RED.png" alt="Demoman Emblem" /></button></Link>
    const HeavyLink = <Link to='heavy'><button className="mercBtn" onMouseEnter={() => setHeavyHover(true)} onMouseLeave={() => setHeavyHover(false)} id="heavyBtn"><img className='emblem' src="/src/assets/emblems/Heavy_emblem_RED.png" alt="Heavt Emblem" /></button></Link>
    const EngineerLink = <Link to='engineer'><button className="mercBtn" onMouseEnter={() => setEngineerHover(true)} onMouseLeave={() => setEngineerHover(false)} id="engineerBtn"><img className='emblem' src="/src/assets/emblems/Engineer_emblem_RED.png" alt="Engineer Emblem" /></button></Link>
    const MedicLink = <Link to='medic'><button className="mercBtn" onMouseEnter={() => setMedicHover(true)} onMouseLeave={() => setMedicHover(false)} id="medicBtn"><img className='emblem' src="/src/assets/emblems/Medic_emblem_RED.png" alt="Medic Emblem" /></button></Link>
    const SniperLink = <Link to='sniper'><button className="mercBtn" onMouseEnter={() => setSniperHover(true)} onMouseLeave={() => setSniperHover(false)} id="sniperBtn"><img className='emblem' src="/src/assets/emblems/Sniper_emblem_RED.png" alt="Sniper Emblem" /></button></Link>
